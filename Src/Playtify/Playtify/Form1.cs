            ...
            if (File.Exists(Application.StartupPath + @"\Playtify.exe.WebView2\EBWebView\Default\IndexedDB\https_open.spotify.com_0.indexeddb.leveldb/LOG.old"))
            {
                try
                {
                    ...
                    string stringinject = @"
                        ...
                        try {
                            var bts = document.querySelectorAll('div.btn-volume.on');
                            for (var i = 0; i < bts.length; i++) {
                                bts[i].click();
                            }
                        }
                        ...
                        try {
                            ...
                            for (var i = 0; i < iframes.length; i++) {
                                if (iframes[i].clientWidth <= document.body.clientWidth - 50 & iframes[i].parentNode.clientWidth <= document.body.clientWidth - 50) {
                        ...
                        try {
                            ...
                            for (var i = 0; i < scripts.length; i++) {
                                var link = scripts[i].src;
                                /*console.log(link);*/
                                if (link.includes('https://track.adform.net/serving/scripts/trackpoint/async/') | link.includes('https://securepubads.g.doubleclick.net/tag/js/gpt.js') | link.includes('https://track.adform.net/Serving/TrackPoint') | link.includes('https://acdn.adnxs.com/dmp/up/pixie.js') | link.includes('https://static.ads-twitter.com/uwt.js') | link.includes('https://www.googleadservices.com/pagead/conversion') | link.includes('https://securepubads.g.doubleclick.net') | link.includes('https://connect.facebook.net/') | link.includes('https://www.googletagmanager.com') | link.includes('https://e-cdn-files.dzcdn.net') | link.includes('https://cdn-assets.dzcdn.net') | link.includes('https://cdn.hubvisor.io') | link.includes('https://analytics.tiktok.com') | link.includes('https://bat.bing.com/p/action') | link.includes('https://mzcreatives.mozoo.com/tracking/mozoo_tracker.js') | link.includes('https://cdn-assets.dzcdn.net/common/js/yzfdmoan.js') | link.includes('https://asset.easydmp.net/js/client.js') | link.includes('https://ct.pinterest.com/static/ct/token_create.js') | link.includes('https://tr.snapchat.com/config/com') | link.includes('https://s.pinimg.com/ct/lib/') | link.includes('https://cdn.segment.com/next-integrations/actions') | link.includes('https://dcniko1cv0rz.cloudfront.net') | link.includes('https://i.realytics.io/tc.js') | link.includes('https://svht.tradedoubler.com/tr_sdk.js') | link.includes('https://sc-static.net/scevent.min.js') | link.includes('https://s.pinimg.com/ct/core.js') | link.includes('https://www.dwin1.com/')) {
                                    scripts[i].remove();
                                }
                            }
                        }
                        ...
                        try {
                            var bts = document.querySelectorAll('.chakra-button');
                            for (var i = 0; i < bts.length; i++) {
                                var retry = bts[i].innerText;
                                if (retry == 'Réessayer' | retry == 'Retry') {
                                    window.location.reload(false);
                                }
                            }
                        }
